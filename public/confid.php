...
Soyez assuré que The district s’est engagé à collecter et utiliser vos données personnelles de manière responsable, sécurisée et en toute transparence. Si vous avez le moindre doute, ou une question, contactez-nous à aline-the_disctric.fr.</p>
 ...
 <p>Lorsque vous rejoignez e-Resto, nous collectons les informations d’enregistrement, afin que nous puissions :</p>
 <ul>
...
<ul>
    ...
    <li>Etudier, analyser, développer et améliorer nos services
</li>
...
<h1>3.Traitement des données</h1>
...
<p>Chez The_district, nous accordons une grande importance à la sécurité et la protection de vos données personnelles, notamment contre tout accès non autorisé, tout traitement illégal, destruction, perte. Notre équipe technique met en oeuvre des mesures afin de garantir la sécurité de vos informations.</p>
<h1>5. Conservation des données</h1>
<p>Chez The_district, nous conservons l’ensemble de vos données le temps nécessaire pour satisfaire aux finalités décrites dans cette Politique de Confidentialité. Par exemple, toute la période durant laquelle votre Restaurant est référencé et présent sur notre plateforme. Dans le cadre de la tenue de nos dossiers, et le respect de nos obligations légales, nous pouvons être à-même de conserver certains éléments de vos données personnelles pour une période ultérieure à votre désactivation et suppression de compte.</p>
<h1>6. Droits relatifs à la protection de vos données</h1>
<p>Vous êtes en droit de nous contacter afin de nous demander de supprimer vos données personnelles ou de limiter leur traitement. Pour se faire, vous pouvez nous contacter sur : alex@e-resto.fr.</p>
<h1>7. Liens vers d’autres sites</h1>
<p>Chez The_district, nous sommes et serons amenés à réaliser des partenariats stratégiques, des liens d’affiliation avec des annonceurs et autres partenaires de différents secteurs. Nos sites web et espaces personnels peuvent donc contenir des liens vers des sites tiers. Si vous suivez ces liens, sachez qu’e-Resto n’est pas responsable de ces sites, qui ont leurs propres Politiques de confidentialité, et mènent leurs propres politiques commerciales</p>
